...
-- $prefix$_user
INSERT INTO $prefix$_user (id, pseudo, first_name, last_name, email, password, email_confirmation, confirm_and_reset_token,
                               phone_number, date_inscription, role_id)
VALUES (uuid_generate_v4(), 'user_pseudo', '$prefix$', 'Pannetrat', '$prefix$@gmail.com', 'Azerty123', TRUE, NULL, 600000001,
        '2023-07-13', (SELECT id FROM $prefix$_role WHERE role_name = 'user')),
       (uuid_generate_v4(), 'admin_pseudo', '$prefix$Admin', 'PannetratAdmin', '$prefix$Admin@gmail.com', 'Azerty123', TRUE, NULL,
        60000000, '2023-07-13', (SELECT id FROM $prefix$_role WHERE role_name = 'admin')),
       (uuid_generate_v4(), 'admin', 'admin', 'admin', 'admin@admion.com', '$2y$10$vJO4N69zIr.t16lOq9VZFeDV4VP0xq/rQp8oALnKyXW14hqwLSUYK', TRUE, 234234234234234234,
        61111111, '2023-07-13', (SELECT id FROM $prefix$_role WHERE role_name = 'admin'));
...
SELECT id
INTO uuid_categorie
FROM $prefix$_game_category
WHERE category_game_name = 'Jeux de cartes';

INSERT INTO $prefix$_game (id, title_game, category_id)
