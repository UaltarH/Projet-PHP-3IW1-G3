                            ...
                            <div class="activity">
                                <?php foreach ($unmoderatedComment as $comment): ?>
                                    <div class="activity-item d-flex">
                                        ...
                                        <a class="activity-content" href="edit/?id=<?= $comment->getId() ?>" style="color: black">
                                            <?= $comment->getContent() ?>
                                        </a>
                                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="activity">
                        <?php foreach ($moderatedComment as $comment): ?>
                            <div class="activity-item d-flex">
                                <div class="activite-label"><?= $comment->getCreationDate() ?></div>
                                <i class='bi bi-circle-fill activity-badge <?= $comment->isModerated() ? $comment->isAccepted() ? "text-success" : "text-warning" : "text-danger" ?> align-self-start'></i>
                            ...
                            <div class="activity">
                                <?php foreach ($allComment as $comment): ?>
                                    <div class="activity-item d-flex">
                                        ...
                                        <div class="activity-content">
                                            <?= $comment->isModerated() ? "Modéré" : "En attente" ?>
                                        </div>
                                        <a class="activity-content" href="edit/?id=<?= $comment->getId() ?>" style="color: black">
                                            <?= $comment->getContent() ?>
                                        </a>
