        ...
        <div class="col-md-6 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <span class="text-black-50"
                      style="text-transform: capitalize"><?= $informationsUser["roleName"] ?></span>
            </div>
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <form
                            method="<?= $editUserForm["config"]["method"] ?>"
                            action="<?= $editUserForm["config"]["action"] ?>"
                            enctype="<?= $editUserForm["config"]["enctype"] ?>"
                            id="<?= $editUserForm["config"]["id"] ?>"
                            class="<?= $editUserForm["config"]["class"] ?>"
                    >
                        ...
                        <div class="mt-5 text-center">
                            <input
                                    class="btn bg-secondary profile-button"
                                    type="submit"
                            >
                        </div>
                    </form>
